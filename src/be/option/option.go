...
var (
	Mode = flag.String("Mode", "DEV", "运行模式(DEV/PRD)")
	...
	DataSourceName = flag.String("DataSourceName", "root:123456@tcp(127.0.0.1:3306)/PDG?autocommit=0&collation=utf8_general_ci", "数据库信息")
