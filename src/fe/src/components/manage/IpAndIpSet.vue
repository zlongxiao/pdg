...
export default {
  ...
  methods: {
    ...
    syncIPS () {
        var that = this
        return axios.post(that.config.getAddress("LIST_IPS"),{token:Cookies.get('token')})
                    .then(response => {
    ...
    removeIPSet (ipset) {
        var that = this
        return axios.post(that.config.getAddress("DELETE_IPSET"), {uuid: ipset.uuid,token:Cookies.get('token')})
                    .then(response => {
                        that.initData()
                    })
                    .catch(error => {
    ...
    createIPSet () {
        var that = this
        return axios.post(that.config.getAddress("CREATE_IPSET"), {cidr: that.createIpsetForm.cidr, comment: that.createIpsetForm.comment,token:Cookies.get('token')})
                    .then(response => {
                        that.initData()
                    })
                    .catch(error => {
