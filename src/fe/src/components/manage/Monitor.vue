...
export default {
  ...
  methods: {
    ...
    syncMonitorBackendCfgs () {
        var that = this
        return axios.post(that.config.getAddress("LIST_MONITOR_BACKEND_CFGS"),{token:Cookies.get('token')})
                    .then(response => {
    ...
    syncAlertItems () {
        var that = this
        return axios.post(that.config.getAddress("LIST_ALERT_ITEMS"),{token:Cookies.get('token')})
                    .then(response => {
    ...
    syncDevices () {
        var that = this
        return axios.post(that.config.getAddress("LIST_DEVICES"),{token:Cookies.get('token')})
                    .then(response => {
    ...
    syncMonitorItems () {
        var that = this
        return axios.post(that.config.getAddress("LIST_MONITOR_ITEMS"),{token:Cookies.get('token')})
                    .then(response => {
    ...
    removeMonitorItem (monitorItem) {
        var that = this
        axios.post(that.config.getAddress("DELETE_MONITOR_ITEM"), {id: monitorItem.id,token:Cookies.get('token')})
             .then(response => {
                 that.initData()
             })
             .catch(error => {
    ...
    getMonitorItem (id) {
        var that = this
        return axios.post(that.config.getAddress("GET_MONITOR_ITEM"), {id: id,token:Cookies.get('token')})
                    .then(response => {
    ...
    listMonitorItemReleatedDevices (itemId) {
        var that = this
        that.bindDevices = []
        return axios.post(that.config.getAddress("LIST_MONITOR_ITEM_RELEATED_DEVICES"), {id: itemId,token:Cookies.get('token')})
                    .then(response => {
                        that.bindDevices = []
    ...
    removeAlertItem (alertItem) {
        var that = this
        axios.post(that.config.getAddress("DELETE_ALERT_ITEM"), {id: alertItem.id,token:Cookies.get('token')})
             .then(response => {
                 that.initData()
             })
             .catch(error => {
