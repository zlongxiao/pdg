...
export default {
  ...
  methods: {
    ...
    syncIPSets () {
        var that = this
        return axios.post(that.config.getAddress("LIST_IPSETS"),{token:Cookies.get('token')})
                    .then(response => {
    ...
    removeDeviceIP (ip) {
        var that = this
        axios.post(that.config.getAddress("DELETE_IP"), {uuid: ip.uuid,token:Cookies.get('token')})
             .then(response => {
                 that.initData()
             })
             .catch(error => {
    ...
    doAddIP () {
        var that = this
        axios.post(that.config.getAddress("CREATE_IP"), {ip_address: that.addIPForm.ipAddress, ip_type: that.editDeviceIPDeviceType, ip_role: that.addIPForm.ipRole, target_id: that.editDeviceIPUUID, ip_set_id: that.addIPForm.ipSetId,token:Cookies.get('token')})
             .then(response => {
                 that.initData()
             })
             .catch(error => {
    ...
    syncDataCenters () {
        var that = this
        return axios.post(that.config.getAddress("LIST_DATACENTERS"),{token:Cookies.get('token')})
                    .then(response => {
    ...
    removeDataCenter (datacenter) {
        var that = this
        axios.post(that.config.getAddress("DELETE_DATACENTER"), {uuid: datacenter.uuid,token:Cookies.get('token')})
             .then(response => {
                 that.initData()
             })
             .catch(error => {
    ...
    createDataCenter () {
        var that = this
        axios.post(that.config.getAddress("CREATE_DATACENTER"), {name: that.createDataCenterForm.name,token:Cookies.get('token')})
             .then(response => {
                 that.initData()
             })
             .catch(error => {
    ...
    syncRacks () {
        var that = this
        return axios.post(that.config.getAddress("LIST_RACKS"),{token:Cookies.get('token')})
                    .then(response => {
    ...
    editRackDatacenter() {
        var that = this
        axios.post(that.config.getAddress("MAPPING_RACK_DATACENTER"), {rack_id: that.editRackUUID, datacenter_id: that.editRackDatacenterForm.datacenterId, position_x: parseInt(that.editRackDatacenterForm.positionX), position_z: parseInt(that.editRackDatacenterForm.positionZ),token:Cookies.get('token')})
             .then(response => {
                 that.initData()
             })
             .catch(error => {
    ...
    editDeviceRack () {
        var that = this
        axios.post(that.config.getAddress("MAPPING_DEVICE_RACK"), {device_id: that.editDeviceRackUUID, device_type: that.editDeviceRackDeviceType, rack_id: that.editDeviceRackForm.rackId, beg_pos: parseInt(that.editDeviceRackForm.begPos), end_pos: parseInt(that.editDeviceRackForm.endPos),token:Cookies.get('token')})
             .then(response => {
                 that.initData()
             })
             .catch(error => {
    ...
    removeRack (rack) {
        var that = this
        axios.post(that.config.getAddress("DELETE_RACK"), {uuid: rack.uuid,token:Cookies.get('token')})
             .then(response => {
                 that.initData()
             })
             .catch(error => {
    ...
    createRack () {
        var that = this
        axios.post(that.config.getAddress("CREATE_RACK"), {name: that.createRackForm.name, size: parseInt(that.createRackForm.size),token:Cookies.get('token')})
             .then(response => {
                 that.initData()
             })
             .catch(error => {
    ...
    syncServerDevices () {
        var that = this
        return axios.post(that.config.getAddress("LIST_SERVERS"),{token:Cookies.get('token')})
                    .then(response => {
    ...
    removeServerDevice (server) {
        var that = this
        axios.post(that.config.getAddress("DELETE_SERVER"), {uuid: server.uuid,token:Cookies.get('token')})
             .then(response => {
                 that.initData()
             })
             .catch(error => {
    ...
    syncStorageDevices () {
        var that = this
        return axios.post(that.config.getAddress("LIST_STORAGE_DEVICES"),{token:Cookies.get('token')})
                    .then(response => {
    ...
    removeStorageDevice (device) {
        var that = this
        axios.post(that.config.getAddress("DELETE_STORAGE_DEVICE"), {uuid: device.uuid,token:Cookies.get('token')})
             .then(response => {
                 that.initData()
             })
             .catch(error => {
    ...
    syncNetworkDevices () {
        var that = this
        return axios.post(that.config.getAddress("LIST_NETWORK_DEVICES"),{token:Cookies.get('token')})
                    .then(response => {
    ...
    removeNetworkDevice (device) {
        var that = this
        axios.post(that.config.getAddress("DELETE_NETWORK_DEVICE"), {uuid: device.uuid,token:Cookies.get('token')})
             .then(response => {
                 that.initData()
             })
             .catch(error => {
    ...
    syncCommonDevices () {
        var that = this
        return axios.post(that.config.getAddress("LIST_COMMON_DEVICES"),{token:Cookies.get('token')})
                    .then(response => {
    ...
    removeCommonDevice (device) {
        var that = this
        axios.post(that.config.getAddress("DELETE_COMMON_DEVICE"), {uuid: device.uuid,token:Cookies.get('token')})
             .then(response => {
                 that.initData()
             })
             .catch(error => {
